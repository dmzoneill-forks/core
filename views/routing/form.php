					...
					<div class="col-md-12">
						<div class="row">
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" class="form-control" id="routename" name="routename" value="<?php echo freepbx_htmlspecialchars($routename ?? '');?>" required>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="row">
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" class="form-control" id="outcid" name="outcid" value="<?php echo freepbx_htmlspecialchars($outcid ?? '');?>">
								</div>
							</div>
						</div>
					</div>
